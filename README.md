...
> **API:** See [Usage: Web Endpoints](#usage-web-endpoints) on how to query this service.
...
The service generates parameterizable bigraph-style location models:

- **Points**: Randomly placed within a given boundary.
- **Uniform n×m×k Grids**: Evenly spaced points with configurable step sizes.
...
Every bigraphical location model generated by this service strictly conforms to the [Bigraph Ecore Metamodel (BEM)](https://github.com/bigraph-toolkit-suite/bigraphs.bigraph-ecore-metamodel), enabling integration, validation, and transformation within EMF-based workflows.
...
### Generate a Bi-spatial Grid with Directional Routes
...
### Generate a Bi-spatial Grid with Diagonal Directional Routes
